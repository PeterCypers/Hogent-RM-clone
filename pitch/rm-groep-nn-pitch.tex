...
\subtitle{Research Methods, 25-26, groep AO2}
\author{Ewout Van Mullem \and Manu Coppens \and Peter Cypers \and Stef Simons}
\date{\today}
...
\begin{frame}
    \frametitle{Voorstel Specialisatiedomein.}
    ...
    \textbf{Probleemstelling:} \lipsum[1][1-2]
\end{frame}

\begin{frame}
    \frametitle{Poster Specialisatiedomein.}
    
    {\huge \textbf{POSTER}}
\end{frame}

\begin{frame}
    \frametitle{Voorstel Interprofessioneel.}
...
\begin{frame}
    \frametitle{Poster Interprofessioneel.}
